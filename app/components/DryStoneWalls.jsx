        ...
        <div className="flex flex-col items-center justify-center text-center">
          <div className="flex-col p-4 w-[90%] md:w-[75%]">
            ...
            <p className="mt-2 text-lg lg:text-xl">
              My Dry Stone Walls website, where I offer professional walling services and comprehensive information on the building, history, and styles of walls in the UK.
              <br />
              There's a short quiz on this site which I've connected to the <span className="underline cursor-pointer hover:text-pink-500" onClick={() => scrollToSection('timewise')}>Timewise</span> site's backend so I can store leaderboard names.
            </p>
            <br />
