  ...
  return (
    <div id="games" className="relative mt-60 font-mono fade-in">
      ...
      <div className="flex justify-center items-center mt-6">
        <div className="w-6 h-6 border-t-2 border-r-2 border-red-600  hover:border-red-700 transform rotate-[135deg] rounded-t rounded-r" onClick={() => scrollToSection('footer')}></div>
      </div>
    </div>
  );
};
