  ...
  return (
    <div className="flex flex-col justify-center m-4">
      <div className="flex justify-center items-center max-h-40 mt-10 mr-2">
        ...
        <img src="../css-logo.png" alt="CSS" title="CSS" className="max-w-40 max-h-20 object-cover mx-1" />
        <img src="../tailwind-logo.png" alt="Tailwind CSS" title="Tailwind CSS" className="max-w-20 max-h-20 object-cover ml-2 mx-1" />
        <img src="../js-logo.png" alt="JavaScript" title="JavaScript" className="max-w-40 max-h-20 object-cover mx-1" />
